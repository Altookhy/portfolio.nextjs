      ...
      content: (
        <div>
          ...
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            ...
            • Used SQL for Data aggregation, merging, and scrapping depending on the client's request.<br />
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            •Developed a web application to track diseases worldwide using React.js and Node.js.<br />
            <div>
              <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
                Using mock data to display it on a map.
              </p>
            </div>
          </p>
        </div>
